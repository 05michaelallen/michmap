...
if flag_REDOWNLOADBADFN:
    ...
    badfn['reconfn'] = badfn['prefix'] + "/CU_LC08.001" + badfn.iloc[:,1] + "_aid0001.tif"
    files_redownload = []
    ...
    files = files_redownload # substitute entire list of requested files with just the ones needed
